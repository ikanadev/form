...
const FormDoc = ({ enqueueSnackbar }) => {
  ...
  const [doc5, setDoc5] = useState('0')
  const [doc6, setDoc6] = useState('0')
  const [doc7, setDoc7] = useState('0')
  const [doc8, setDoc8] = useState('0')
  ...
  const [doc14a, setDoc14a] = useState('')
  const [doc14b, setDoc14b] = useState('')
  const [doc14c, setDoc14c] = useState('')
  const [doc14d, setDoc14d] = useState('')
  const [doc15, setDoc15] = useState('')
  // II. VINCULACIÓN CON LA CARRERA
  const [doc16, setDoc16] = useState('0')
  ...
  const [doc24a, setDoc24a] = useState('')
  const [doc25, setDoc25] = useState('')
  const [doc25a, setDoc25a] = useState('')
  const [doc26, setDoc26] = useState('')
  const [doc26a, setDoc26a] = useState('')
  const [doc27, setDoc27] = useState('')
  const [doc27a, setDoc27a] = useState('')
  // V. INFRAESTRUCTURA
  const [doc28, setDoc28] = useState('')
  const [doc29, setDoc29] = useState('')
  // VI. GRADOS, TITULACION Y MENCIONES
  const [doc30, setDoc30] = useState('')
  const [doc31, setDoc31] = useState('')
  const [doc32, setDoc32] = useState('')
  const [doc33, setDoc33] = useState('0')
  const [doc34, setDoc34] = useState('')
  const [doc35, setDoc35] = useState('')
  const [doc36, setDoc36] = useState('0')
  // VII. AREAS DE CONOCIMIENTO
  const [doc37, setDoc37] = useState('')
  const [doc38, setDoc38] = useState('')
  const [doc39, setDoc39] = useState('')
  const [doc40, setDoc40] = useState('')
  const [doc41, setDoc41] = useState('')
  // VIII. COMPETENCIAS DEL PROFESIONAL EN EL ÁREA DE LA INFORMÁTICA Y SIST.
  const [doc42, setDoc42] = useState('')
  const [doc43, setDoc43] = useState('')
  const [doc44, setDoc44] = useState('')
  // IX. SUGERENCIAS
  const [doc45, setDoc45] = useState('')
  // DATOS DE LA ENCUESTA
  const [doc46, setDoc46] = useState('')
  const [doc47, setDoc47] = useState('2000-11-01')
